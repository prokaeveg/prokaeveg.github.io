        ...
        form.addEventListener("submit", function(event) {
            ...
            if (presenceOption && presenceOption.value === 'К сожалению, не смогу присутствовать') {
                ...
                var questions = [
                    ...
                    {lid: "1697381978827", errorMessage: "Выберите один или несколько, нам будет проще рассчитать алкоголь"},
                ];
                ...
                if (hasError) {
                    ...
                    localStorage.setItem('formSubmitted', true); //Запретить отправку формы повторно
